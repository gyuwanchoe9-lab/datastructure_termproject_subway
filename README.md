...
* or any advaned algorithm can be used for the enhancement (Ex, dijkstra algorithm)
...
transfer time : 2 minutes from line #1 sindorim to line#2 sindorim -> (1,sindorim), (2,sindorim), 2

 

----------------------

submission via e-class with the following items

 1. program code with any data files, you made

 2. presentation file (PPT or PDF) including

 3. 2-minute explaination video (explaining the PPT file)

 4. demonstration result screen shot

-----------------------------------

1호선-5호선 노선 (subway line #1 ~ #5)
